...
$qselect='SELECT ticket.ticket_id,ticket.`number`,ticket.dept_id,isanswered, '
    .'dept.ispublic, subject.value as subject, users.name as person, '
    .'dept_name,ticket.status, ticket.source, ticket.created '
	.' ,status.statusName, status.colorBG as bg, status.colorFG as fg, status.colorBD as bd';
            ...
            <tr id="<?php echo $row['ticket_id']; ?>">
                ...
                <td>&nbsp;<?php echo Format::db_date($row['created']); ?></td>
                  ...
                  <td nowrap style='vertical-align:middle; text-align:center;'>
                    <center>
                    <div name='shape' style='font-size:8pt;'><?php echo $row['statusName'];?></div>
                    </center>
                    </td>
                  <?php	
                    }
