...
class AdminNav extends StaffNav{
    ...
    function getTabs(){
        ...
        if(!$this->tabs){
			...
			$tabs['modules']=array('desc'=>__('Modules'),'href'=>'module.php','title'=>__('Modules'));
            if (count($this->getRegisteredApps()))
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'settings':
					...
					$subnav[]=array('desc'=>__('Modules'),'href'=>'settings.php?t=modules','iconclass'=>'preferences');
                ...
                case 'staff':
                    ...
                    break;
				case 'modules':
					$subnav[]=array('desc'=>__('Change Log'),'href'=>'module.php?t=changelog','iconclass'=>'pages');
					/****************************
