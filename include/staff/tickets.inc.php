 ...
 <table class="list" border="0" cellspacing="1" cellpadding="2" width="940">
    ...
    <thead>
        <tr>
            ...
            ?>
                    <th width="100">
                        <a <?php echo $name_sort; ?> href="tickets.php?sort=tstatus&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                             title="Sort By Ticket Status <?php echo $negorder; ?>">Status</a></th>
            <?php
				}
			?>
            <th width="150">
            ...
            <tr id="<?php echo $row['ticket_id']; ?>">
                ...
                <td><a <?php if ($flag) { ?> class="Icon <?php echo $flag; ?>Ticket" title="<?php echo ucfirst($flag); ?> Ticket" <?php } ?>	<?php //Subject Column ?>
                  ...
                  <td nowrap style='vertical-align:middle; text-align:center;'>
                    <center>
                    <div name='shape' style='background-color:<?php echo $row['bg'];?>; color:<?php echo $row['fg'];?>; border-color:<?php echo $row['bd'];?>;
                  <?php
                    $sql = "SELECT propertyName, valueCurrent FROM ".MOD_STATUS_PROPERTY." WHERE objectId=".$cfg->get('mod_status_default_shape');
                    $res = db_query($sql);
                    while(list($property, $val)=db_fetch_row($res)){
                        echo " " . $property . ": " . $val . ";";
                    }
                  ?>  
